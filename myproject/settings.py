...
SECRET_KEY = 'django-insecure-%z*2879=-+!q8-fl=h*=ga057)gf61q*^2&u1yrgdkdsg(#bwa'
...
# Added manually, uses to specify other directories from which to load static files
STATICFILES_DIRS = [
