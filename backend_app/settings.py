...
SECRET_KEY = 't8yuwqPpt8-0VajqNRJ-qvO_odHOlBc1ugbqRmZIcH8AD5UDTS0rjpSfuwxsqjXPeQo'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False
APPEND_SLASH = True

ALLOWED_HOSTS = ["www.algostrike.com", "algostrike.com"]
...
# Added manually, for production level otherwise shows error in localserver
...
# Added manually if you have other directories of static files.
